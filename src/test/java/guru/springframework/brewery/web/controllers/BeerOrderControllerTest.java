...
class BeerOrderControllerTest {
    ...
    void setUp() {
        ...
        beerOrder = BeerOrderDto.builder().id(UUID.randomUUID())
                .beerOrderLines(List.of(BeerOrderLineDto.builder().beerId(validBeer.getId()).build())).build();
    ...
    void listOrders() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/customers/" + validBeer.getId() + "/orders", UUID.randomUUID()))
    ...
    void getOrder() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/customers/" + validBeer.getId() + "/orders/" + beerOrder.getId()))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8));
    }
}